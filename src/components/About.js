...
const About = () => {
  return (
    <div className="h-full lg:h-screen bg-[#31363fe9] flex flex-col justify-start py-10 items-start lg:items-center">
      <h1 className="text-6xl font-bold p-10">Our Team</h1>
      <div className=" lg:mb-0 flex flex-col lg:flex-row justify-center items-center flex-wrap shrink-0 gap-5">
