...
const MovieDetails = () => {
  ...
  const isBookmarked = useMemo(() => {
    return bookmark.some(
      (bookmarkedMovie) => bookmarkedMovie.id === movieDetails.id
    );
  ...
  return (
    <div className="bg-[#1C2026]">
      <div className="">
        <div
          style={{
            "--image-url": `url(https://image.tmdb.org/t/p/w500${movieDetails.backdrop_path})`,
          }}
            ...
            <div className="py-10 w-3/5 flex flex-col items-start lg:flex-row  lg:items-center justify-center gap-10 text-white">
              <div className="flex flex-col justify-center items-start lg:items-center  gap-2">
                ...
                <button
                  ...
                  className="w-[300px] px-3 py-1 bg-[#1B6F93] rounded-lg"
                >
                  Trailer
                </button>
                <button
                  onClick={handleBookmark}
                  className={`w-[300px] px-3 py-1  rounded-lg ${
                    isBookmarked ? "bg-[#13516c]" : "bg-[#1B6F93]"
                  } `}
                >
              ...
              <div className="flex flex-col justify-center items-start gap-2 text-white text-start">
                ...
                <p className="p-1">
                  Director: {director[0] && director[0].name}
                </p>
